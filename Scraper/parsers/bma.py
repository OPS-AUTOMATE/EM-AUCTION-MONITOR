...
async def scrape_bma(url: str):
    """
    Scrapes British Medical Auctions (BMA).
    Example URL structure: https://britishmedicalauctions.com/lots/...
    """
    async with async_playwright() as p:
        ...
        try:
            ...
            if await page.locator(".countdown, .time-left").count() > 0:
                time_remaining = await page.locator(".countdown, .time-left").first.inner_text()
